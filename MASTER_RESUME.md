...
- NOTE (surfaced during merge, Jul 2026): the Epicenter role (~2004–2007) involved on-site IT support for ~20 external client companies — this is genuine client-facing experience that predates the "no client-facing experience" gap noted elsewhere in this file. Revisit that gap note and any tailored resumes built before this merge (e.g., the CluedIn Data Implementation Consultant resume) to reflect this if relevant.
